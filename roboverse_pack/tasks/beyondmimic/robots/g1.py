...
ASSET_DIR = (
    "/home/hongyu/whole_body_tracking/source/whole_body_tracking/whole_body_tracking/assets"  # FIXME hard-coded for now
)
...
G1_ACTION_SCALE = {}  # TODO check action scales
