    ...
    * **Recorder Manager**: The recorder manager that handles recording data produced during different steps
    ...
    def __init__(self, cfg: ManagerBasedEnvCfg):
        ...
        if SimulationContext.instance() is None:
            ...
            self.sim: SimulationContext = SimulationContext(self.cfg.sim)  # NOTE `device` = "cuda:0"
        else:
    ...
    def load_managers(self):
        ...
        if self.__class__ == ManagerBasedEnvV1 and "startup" in self.event_manager.available_modes:
