...
class MotionCommand(CommandTerm):
    """Command term for motion tracking that provides reference motion data."""
    ...
    def robot_body_quat_w(self) -> torch.Tensor:
        """Current robot body orientations in world frame."""
        return self.robot.data.body_quat_w[:, self.body_indexes]

    @property
    def robot_body_lin_vel_w(self) -> torch.Tensor:
        """Linear velocities of robot bodies in world frame."""
        return self.robot.data.body_lin_vel_w[:, self.body_indexes]

    @property
    def robot_body_ang_vel_w(self) -> torch.Tensor:
        """Angular velocities of robot bodies in world frame."""
        return self.robot.data.body_ang_vel_w[:, self.body_indexes]

    @property
    def robot_anchor_pos_w(self) -> torch.Tensor:
        """Position of robot anchor body in world frame."""
        return self.robot.data.body_pos_w[:, self.robot_anchor_body_index]

    @property
    def robot_anchor_quat_w(self) -> torch.Tensor:
        """Orientation quaternion of robot anchor body in world frame."""
        return self.robot.data.body_quat_w[:, self.robot_anchor_body_index]

    @property
    def robot_anchor_lin_vel_w(self) -> torch.Tensor:
        """Linear velocity of robot anchor body in world frame."""
        return self.robot.data.body_lin_vel_w[:, self.robot_anchor_body_index]

    @property
    def robot_anchor_ang_vel_w(self) -> torch.Tensor:
        """Angular velocity of robot anchor body in world frame."""
