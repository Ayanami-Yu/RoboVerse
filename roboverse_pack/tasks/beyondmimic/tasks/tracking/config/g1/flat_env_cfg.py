...
from beyondmimic.robots.g1 import G1_ACTION_SCALE, G1_CYLINDER_CFG
from beyondmimic.tasks.tracking.config.g1.agents.rsl_rl_ppo_cfg import LOW_FREQ_SCALE
