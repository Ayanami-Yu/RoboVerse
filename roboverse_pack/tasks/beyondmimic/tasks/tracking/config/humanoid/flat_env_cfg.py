...
from beyondmimic.robots.smpl import SMPL_HUMANOID
from beyondmimic.tasks.tracking.tracking_env_cfg import TrackingEnvCfg


@configclass
class HumanoidFlatEnvCfg(TrackingEnvCfg):
    """Environment configuration for SMPL humanoid motion tracking on flat terrain."""
...
class HumanoidFlatWalkEnvCfg(HumanoidFlatEnvCfg):
    """Humanoid environment configuration for walking motion."""
...
class HumanoidFlatWalkBackEnvCfg(HumanoidFlatEnvCfg):
    """Humanoid environment configuration for backward walking motion."""
...
class HumanoidFlatWalkBoxEnvCfg(HumanoidFlatEnvCfg):
    """Humanoid environment configuration for box walking motion."""
